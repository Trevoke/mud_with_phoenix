...
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {socket: a, input: b, logLines: c};
	});
var _user$project$App$HandleSendError = function (a) {
	return {ctor: 'HandleSendError', _0: a};
};
var _user$project$App$ReceiveLogLine = function (a) {
	return {ctor: 'ReceiveLogLine', _0: a};
};
var _user$project$App$SendInput = {ctor: 'SendInput'};
var _user$project$App$SetInput = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onSubmit(_user$project$App$SendInput)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onInput(_user$project$App$SetInput)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
...
var _user$project$App$init = function () {
	...
	var _p0 = A2(
		...
		A4(
			...
			'shout',
			'room:lobby',
			_user$project$App$ReceiveLogLine,
	...
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$PhoenixMsg, command)
	};
}();
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'PhoenixMsg':
				var _p2 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p1._0, model.socket);
				var socket = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
			...
			case 'SendInput':
				...
				var push = A2(
					...
					_user$project$App$HandleSendError,
					A2(
			...
			case 'ReceiveLogLine':
				var messageDecoder = A2(_elm_lang$core$Json_Decode_ops[':='], 'input', _elm_lang$core$Json_Decode$string);
				var receivedLogLine = A2(_elm_lang$core$Json_Decode$decodeValue, messageDecoder, _p1._0);
				var _p4 = receivedLogLine;
				if (_p4.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								logLines: A2(_elm_lang$core$List_ops['::'], _p4._0, model.logLines)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								logLines: A2(_elm_lang$core$List_ops['::'], 'Failed to receive log line', model.logLines)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
				var message = 'Failed to send command';
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							logLines: A2(_elm_lang$core$List_ops['::'], message, model.logLines)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$App$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$App$PhoenixMsg);
};
